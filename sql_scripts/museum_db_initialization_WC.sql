...
VALUES (
    ...
    (
        ...
        'Still-life painting of café fare and a newspaper.',
        'Spanish',
        'Modern',
        'Permanent',
        'Painting',
    ...
    (
        '489783717',
        '1814',
        'An odalisque, called The Great Odalisque',
    ...
    (
        ...
        '1799',
        'The Sabines',
        'Painting of the intervention of the Sabine women.',
        'French',
        'Neoclassicism',
        'Borrowed',
        'Painting',
    ...
    (
        '555888385',
        '1857',
        'Vue de Real del Monte, province de Hidalgo (Mexique)',
...
VALUES (
        '437018134',
        'Department of Art Objects from the Middle Ages, Renaissance and Modern Times',
        '2000-04-09',
        '2002-07-08'
    ),
    (
