...
( EID			  CHAR(9)           NOT NULL,
  ...
  CONSTRAINT DISPFK FOREIGN KEY (EID) REFERENCES EXHIBITION(EX_ID)	ON DELETE CASCADE	ON UPDATE CASCADE);
...
VALUES      ('111363504','1544','Field Armor of King Henry VIII','Armor made for Henry VIII.','Italian, Milan or Brescia','Renaissance','Permanent','Other',null),
            ('198404671','1600','Bearing Cloth','Needlework from England.','British','Renaissance','Permanent','Other',null),
            ('120297468','1564','The Lewknor Table Carpet','Ornamental table covering.','Netherlandish, probably Enghien','Renaissance','Permanent','Other',null),
            ('126339216','1510','Portrait Bust of John Fisher','Sculpture of John Fisher.','British','Renaissance','Permanent','Sculpture','Pietro Torrigiano'),
            ('103967204','1532','Hermann von Wedigh III (died 1560)','Portrait of Hermann von Wedigh III.','German','Renaissance','Permanent','Painting','Hans Holbein the Younger'),
            ('107937322','1597','Ellen Maurice','Portrait of Ellen Maurice.','Flemish','Renaissance','Permanent','Painting','Marcus Gheeraerts the Younger'),
            ('260892373','1916','Bottle and Fruit Dish','Cubist painting.','Spanish','Modern','Permanent','Painting','Juan Gris'),
            ('230840004','1636','Still Life with Four Bunches of Grapes','Still-life painting of grapes.','Spanish','Renaissance','Permanent','Painting','Juan Fernández'),
            ('208742683','1912','Still Life with Chair Caning','Still-life painting of a newspaper.','Spanish','Modern','Permanent','Painting','Pablo Picasso'),
            ('260986041','1665','The Attributes of the Painter','Painting of an artist''s studio wall','Flemish','Baroque','Permanent','Painting','Cornelius Norbertus Gijsbrechts'),
            ('375146957','2019','108 (Face Jug Series)','Face jug.','American','Modern','Permanent','Sculpture','Simone Leigh'),
            ('371155323','2020','Signature Study','High fire stoneware with glaze','American','Modern','Permanent','Statue','Theaster Gates'),
            ('388971469','2019','Birth and Rebirth and Rebirth','African pastel portrait','African','Modern','Permanent','Other','Robert Pruitt'),
			('437018134','1677','Chest of jewels of Louis XIV','Decorated oak chest','French','Renaissance','Borrowed','Other','Jakob Orfèvre Blanck'),
            ('489783717','1814','Grande Odalisque','Oil painting of an odalisque.','French','Romanticism','Borrowed','Painting','Jean-Auguste-Dominique Ingres'),
            ('423318619','1799','The Sabines','Painting of the intervention of the Sabine women.','French','Neoclassicism','Borrowed','Painting','Jacques-Louis David'),
            ('503335428','1740','Vue du Forum a Rome','Painting of the forum in Rome.','Italian','Neoclassicism','Borrowed','Painting','Giovanni Paolo Panini'),
            ('555888385','1857','Vue de Real del Monte','Painting of Real del Monte','Italian','Romanticism','Borrowed','Painting','Eugenio Landesio'),
...
VALUES      ('437018134','Masterpieces of the Louvre','2000-04-09','2002-07-08'),
			('556140261','Masterpieces of the Louvre','2019-06-30','2021-10-04'),
            ('489783717','National Museums Recovery','2004-01-27','2006-02-16'),
            ('423318619','National Museums Recovery','1997-11-12','1998-06-03'),
            ('503335428','National Museums Recovery','1994-09-10','1996-11-25'),
            ('555888385','National Museums Recovery','1981-03-03','1983-04-19');